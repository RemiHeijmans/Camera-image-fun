...
public class ImageToASCIIConverter100x100 {
    ...
    public static void main(String[] args) {
        ...
        // Resize the image to a smaller size for ASCII art
        Mat resizedImage = new Mat();
        Imgproc.resize(image, resizedImage, new Size(100, 100)); // Adjust size as needed
